...
//previously this led was at pin 2 
#define led 8
int s1,s2;
char dir;
int chr = 0;
...
// chosing the path white or black line
startTime = millis();
...
if(!lineColor)
{
// this if statement is not really necessary. if we gotta blink something we gotta use this. else 
// the flag is false if the switch isn't pressed from above while statement
}
